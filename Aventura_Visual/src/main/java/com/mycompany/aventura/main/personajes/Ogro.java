...
public class Ogro extends Personaje {
        ...
        while (!paso) {
            ...
            if (seMovio) {
                ...
                if (!hayObstaculos) {
                    ...
                    if (comando.equals("a")) { 
                        accion = "El Ogro (" + fila + "," + columna + ") se Movio a la Izquierda";
                    } else if (comando.equals("d")) { 
                        accion = "El Ogro (" + fila + "," + columna + ") se Movio a la Derecha";
                    } else if (comando.equals("w")) { 
                        accion = "El Ogro (" + fila + "," + columna + ") se Movio hacia Arriba";
                    } else {
                        accion = "El Ogro (" + fila + "," + columna + ") se Movio hacia Abajo";
                    }
    ...
    public void atacarPersonaje(ListaElementos<Casilla> tablero, ListaElementos<Arbol> arboles, ListaElementos<Personaje> personajesEnemigos, ListaElementos<String> casillasAnteriores, String direccion, ListaElementos<String> accionesEnemigos) {
        ...
        int filaAtacada = 0, columnaAtacada = 0;
        String accion = null;
                    ...
                    try {
                        if (tablero.obtenerContenido(i).obtenerFila() == (fila - 1) && tablero.obtenerContenido(i).obtenerColumna() == (columna - 1)) {
                            if ("caballero".equals(tablero.obtenerContenido(i).obtenerTipoDeCasilla()) || "arquero".equals(tablero.obtenerContenido(i).obtenerTipoDeCasilla()) || "mago".equals(tablero.obtenerContenido(i).obtenerTipoDeCasilla()) || "gigante".equals(tablero.obtenerContenido(i).obtenerTipoDeCasilla()) || "dragon".equals(tablero.obtenerContenido(i).obtenerTipoDeCasilla())) {
                                ...
                                dos = tres = cuatro = cinco = seis = siete = ocho = false;
                            } else {
                                numero = 2;
                            }
                        }
                    ...
                    try {
                        if (tablero.obtenerContenido(i).obtenerFila() == (fila - 1) && tablero.obtenerContenido(i).obtenerColumna() == (columna)) {                  
                            if ("caballero".equals(tablero.obtenerContenido(i).obtenerTipoDeCasilla()) || "arquero".equals(tablero.obtenerContenido(i).obtenerTipoDeCasilla()) || "mago".equals(tablero.obtenerContenido(i).obtenerTipoDeCasilla()) || "gigante".equals(tablero.obtenerContenido(i).obtenerTipoDeCasilla()) || "dragon".equals(tablero.obtenerContenido(i).obtenerTipoDeCasilla())) {
                                ...
                                uno = tres = cuatro = cinco = seis = siete = ocho = false;
                            } else {
                                numero = 3;
                            }
                        }
                    ...
                    try {
                        if (tablero.obtenerContenido(i).obtenerFila() == (fila - 1) && tablero.obtenerContenido(i).obtenerColumna() == (columna + 1)) {                  
                            if ("caballero".equals(tablero.obtenerContenido(i).obtenerTipoDeCasilla()) || "arquero".equals(tablero.obtenerContenido(i).obtenerTipoDeCasilla()) || "mago".equals(tablero.obtenerContenido(i).obtenerTipoDeCasilla()) || "gigante".equals(tablero.obtenerContenido(i).obtenerTipoDeCasilla()) || "dragon".equals(tablero.obtenerContenido(i).obtenerTipoDeCasilla())) {
                                filaAtacada = fila - 1;
                                columnaAtacada = columna + 1;
                                uno = dos = cuatro = cinco = seis = siete = ocho = false;
                            } else {
                                numero = 4;
                            }
                        }
                    ...
                    try {
                        if (tablero.obtenerContenido(i).obtenerFila() == fila && tablero.obtenerContenido(i).obtenerColumna() == (columna - 1)) {                  
                            if ("caballero".equals(tablero.obtenerContenido(i).obtenerTipoDeCasilla()) || "arquero".equals(tablero.obtenerContenido(i).obtenerTipoDeCasilla()) || "mago".equals(tablero.obtenerContenido(i).obtenerTipoDeCasilla()) || "gigante".equals(tablero.obtenerContenido(i).obtenerTipoDeCasilla()) || "dragon".equals(tablero.obtenerContenido(i).obtenerTipoDeCasilla())) {
                                filaAtacada = fila;
                                columnaAtacada = columna - 1;
                                uno = dos = tres = cinco = seis = siete = ocho = false;
                            } else {
                                numero = 5;
                            }
                        }
                    ...
                    try {
                        if (tablero.obtenerContenido(i).obtenerFila() == fila && tablero.obtenerContenido(i).obtenerColumna() == (columna + 1)) {                  
                            if ("caballero".equals(tablero.obtenerContenido(i).obtenerTipoDeCasilla()) || "arquero".equals(tablero.obtenerContenido(i).obtenerTipoDeCasilla()) || "mago".equals(tablero.obtenerContenido(i).obtenerTipoDeCasilla()) || "gigante".equals(tablero.obtenerContenido(i).obtenerTipoDeCasilla()) || "dragon".equals(tablero.obtenerContenido(i).obtenerTipoDeCasilla())) {
                                filaAtacada = fila;
                                columnaAtacada = columna + 1;
                                uno = dos = tres = cuatro = seis = siete = ocho = false;
                            } else {
                                numero = 6;
                            }
                        }
                    ...
                    try {
                        if (tablero.obtenerContenido(i).obtenerFila() == (fila + 1) && tablero.obtenerContenido(i).obtenerColumna() == (columna - 1)) {                  
                            if ("caballero".equals(tablero.obtenerContenido(i).obtenerTipoDeCasilla()) || "arquero".equals(tablero.obtenerContenido(i).obtenerTipoDeCasilla()) || "mago".equals(tablero.obtenerContenido(i).obtenerTipoDeCasilla()) || "gigante".equals(tablero.obtenerContenido(i).obtenerTipoDeCasilla()) || "dragon".equals(tablero.obtenerContenido(i).obtenerTipoDeCasilla())) {
                                filaAtacada = fila + 1;
                                columnaAtacada = columna - 1;
                                uno = dos = tres = cuatro = cinco = siete = ocho = false;
                            } else {
                                numero = 7;
                            }
                        }
                    ...
                    try {
                        if (tablero.obtenerContenido(i).obtenerFila() == (fila + 1) && tablero.obtenerContenido(i).obtenerColumna() == columna) {                  
                            if ("caballero".equals(tablero.obtenerContenido(i).obtenerTipoDeCasilla()) || "arquero".equals(tablero.obtenerContenido(i).obtenerTipoDeCasilla()) || "mago".equals(tablero.obtenerContenido(i).obtenerTipoDeCasilla()) || "gigante".equals(tablero.obtenerContenido(i).obtenerTipoDeCasilla()) || "dragon".equals(tablero.obtenerContenido(i).obtenerTipoDeCasilla())) {
                                filaAtacada = fila + 1;
                                columnaAtacada = columna;
                                uno = dos = tres = cuatro = cinco = seis = ocho = false;
                            } else {
                                numero = 8;
                            }
                        }
                    ...
                    try {
                        if (tablero.obtenerContenido(i).obtenerFila() == (fila + 1) && tablero.obtenerContenido(i).obtenerColumna() == (columna + 1)) {                  
                            if ("caballero".equals(tablero.obtenerContenido(i).obtenerTipoDeCasilla()) || "arquero".equals(tablero.obtenerContenido(i).obtenerTipoDeCasilla()) || "mago".equals(tablero.obtenerContenido(i).obtenerTipoDeCasilla()) || "gigante".equals(tablero.obtenerContenido(i).obtenerTipoDeCasilla()) || "dragon".equals(tablero.obtenerContenido(i).obtenerTipoDeCasilla())) {
                                filaAtacada = fila + 1;
                                columnaAtacada = columna + 1;
                                uno = dos = tres = cuatro = cinco = seis = siete = false;
                            } else {
                                numero = 9;
                            }
                        }
        ...
        if (random < porcentajeDeEfectividad) {
                        ...
                        if (arboles.obtenerContenido(j).obtenerFila() == filaAtacada && arboles.obtenerContenido(j).obtenerColumna() == columnaAtacada) {
                            if (arboles.obtenerContenido(j).obtenerSiElArbolEstaActivo()) {
                                ...
                                if (arboles.obtenerContenido(j).obtenerVida() == 0) {
                                    ...
                                    arboles.eliminar(j);
                                    accion = "El Ogro (" + fila + "," + columna + ") destruyó un Árbol";
                                } else {
                                    accion = "El Ogro (" + fila + "," + columna + ") hizó un daño de " + daño + " a un Árbol";
                                }
                                encontroAlgo = true;
                                break;
                            }
                    ...
                    try {
                        if (personajesEnemigos.obtenerContenido(j).obtenerFilaDelJugador() == filaAtacada && personajesEnemigos.obtenerContenido(j).obtenerColumnaDelJugador() == columnaAtacada) {
                            ...
                            if (personajesEnemigos.obtenerContenido(j).obtenerVida() == 0) {
                                ...
                                accion = "El Ogro (" + fila + "," + columna + ") dejó fuera de Combate a " + personajesEnemigos.obtenerContenido(j).obtenerNombre();
                                personajesEnemigos.eliminar(j);
                            } else {
                                accion = "El Ogro (" + fila + "," + columna + ") atacó a " + personajesEnemigos.obtenerContenido(j).obtenerNombre() + " dejandoló con " + personajesEnemigos.obtenerContenido(j).obtenerVida() + " de vida";
                            }
                            encontroAlgo = true;
                            break;
                        }
            ...
            if (!encontroAlgo) {
                accion = "El Ogro (" + fila + "," + columna + ") atacó pero no habia Objetivos Cerca";
            }
        } else {
            accion = "El Ogro (" + fila + "," + columna + ") falló el Ataque";
        }
        accionesEnemigos.agregarALaLista(accion);
    }
}
